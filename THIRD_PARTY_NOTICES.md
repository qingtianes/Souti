...
| Apache POI HSSF 5.2.5 | `.xls` 文件解析 | Apache License 2.0 |
| Log4j API 2.21.1 | Apache POI 日志 API 依赖 | Apache License 2.0 |
...
Souti 使用 Apache POI HSSF 5.2.5 读取旧式 `.xls` 文件，未修改其上游源代码。Apache POI 及其适用传递依赖按 Apache License 2.0 或各自原始许可证分发。
